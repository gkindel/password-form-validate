...
import {useFormValidator, ValidationError} from "./module/useFormValidator.ts";
...
function PasswordForm() {
    ...
    const _handleSubmit = useCallback( (e:React.FormEvent):void => {
    ...
    return (
        <div>
            ...
            <StyledForm onSubmit={_handleSubmit}>
                ...
                <StyledErrors>
                    {errors.map((e: ValidationError, i) => <div key={i}>{e.message}</div>)}
                </StyledErrors>
                <PasswordInput
                    name={'mypassword'}
                    register={register}
